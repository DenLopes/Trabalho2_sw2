...
<template>
  <div class="bg-slate-900 h-full">
    ...
    >
      <h2 class="text-green-500 text-center text-2xl font-bold mb-28">
        O que é o IBAMA?
      </h2>
      <div class="flex flex-row m-4 justify-around mb-40">
        <p class="w-[70%] leading-9">
          O Instituto Brasileiro do Meio Ambiente e dos Recursos Naturais
          Renováveis (IBAMA) foi criado em 1989, por meio da Lei nº 7.735, com o
          objetivo de unificar e fortalecer as ações de proteção e conservação
          do meio ambiente no Brasil. Desde sua criação, o IBAMA tem
          desempenhado um papel essencial na proteção ambiental do país. O órgão
          atua em âmbito nacional, sendo vinculado ao Ministério do Meio
          ...
          IBAMA tem enfrentado diversos desafios e desenvolvido ações para
          combater crimes ambientais, promover a conservação da biodiversidade e
          assegurar o uso sustentável dos recursos naturais. Alguns marcos
          importantes na história do IBAMA incluem:
        </p>
        <img src="../assets/brasil.png" alt="brasil" class="w-44 h-44" />
      </div>
      <div class="flex flex-row m-4 justify-around">
        <span class="text-green-500">GRAFICO</span>
        <p class="w-[70%]">
          Combate ao desmatamento: O IBAMA tem desempenhado um papel fundamental
          no combate ao desmatamento ilegal na Amazônia e em outras regiões do
          país. Por meio de operações de fiscalização e monitoramento, o órgão
          busca identificar áreas desmatadas irregularmente, autuar os
          responsáveis e promover a recuperação de áreas degradadas.
        </p>
      </div>
      <div class="flex flex-row m-4 justify-around mb-40">
        <p class="w-[70%] leading-9">
